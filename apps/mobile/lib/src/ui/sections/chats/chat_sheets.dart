// Bottom sheets and dialogs owned by the Chats section.
//
// Split out of the old shared `ui/sheets.dart` when the app grew sections: the
// language picker in that file belonged to Profile, and one file that two
// sections both had to edit is exactly the coupling the section boundary
// exists to prevent.
